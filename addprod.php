...
<div class="container">
        ...
        <div class="card-body">
  <form role="form" method="post" action="transactionsave.php?action=adds" onsubmit="return validateDeliveryDate()">
...
<script>
    function validateDeliveryDate() {
        var deliveryDate = document.getElementsByName('del')[0].value;
